        ...
        <div class="form-row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" id="categoryTitle" class="form-control" placeholder="Название" name="title" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="categorySort">Порядок</label>
                    <input type="number" id="categorySort" class="form-control" placeholder="Порядок" name="sort_order" value="0">
                </div>
            </div>
        </div>
